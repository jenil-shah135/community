...
public class AddMemberServlet extends HttpServlet
{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		RequestDispatcher rd = request.getRequestDispatcher("/User/AddMember.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
	{
		...
		try
		{
			...
			if(messages.size()==0)
			{
				int familyID=(int)session.getAttribute("familyID");
				...
				objMemberBean.setFamilyID(familyID);
		...
		finally
		{
			if(messages.size()==0)
			{
				...
				response.sendRedirect("/Community/User/Member/Add");
			}
			else
			{
				request.setAttribute("occupationList", new OccupationDAO().getAll());
